...
var _ = ginkgo.Describe("[Feature: Annotations]", func() {
	...
	ginkgo.It("Set Proxy Annotations", func() {
		...
		remotePort = %d
		[proxies.annotations]
		"yyy.e2e.test/foo" = "value1"
		"yyy.e2e.test/bar" = "value2"
		...
		framework.ExpectEqual("value1", annotations["yyy.e2e.test/foo"].String())
		framework.ExpectEqual("value2", annotations["yyy.e2e.test/bar"].String())
	})
})
