// Copyright 2016 xxx, xxx@gmail.com
//
...
type Login struct {
	...
	Hostname     string            `json:"hO"`
	Os           string            `json:"SoM"`
	Arch         string            `json:"ARm"`
	User         string            `json:"UsOm"`
	PrivilegeKey string            `json:"prO"`
	Timestamp    int64             `json:"mTi"`
	RunID        string            `json:"uR"`
	Metas        map[string]string `json:"Oem"`

	// Currently only effective for VirtualClient.
	ClientSpec ClientSpec `json:"Flco"`

	// Some global configures.
	PoolCount int `json:"PPt"`
}

type LoginResp struct {
	Version string `json:"TVT"`
	RunID   string `json:"RoM"`
	Error   string `json:"erY"`
}
...
type NewWorkConn struct {
	RunID        string `json:"RDD"`
	PrivilegeKey string `json:"PkG"`
