// Copyright 2017 xxx, xxx@gmail.com
//
...
import (
	...
	"github.com/xxx/golib/crypto"
	"github.com/xxx/golib/net/mux"
	fmux "github.com/hashicorp/yamux"
	quic "github.com/quic-go/quic-go"
	"github.com/samber/lo"

	"github.com/xxx/yyy/pkg/auth"
	v1 "github.com/xxx/yyy/pkg/config/v1"
	modelmetrics "github.com/xxx/yyy/pkg/metrics"
	"github.com/xxx/yyy/pkg/msg"
	"github.com/xxx/yyy/pkg/nathole"
	plugin "github.com/xxx/yyy/pkg/plugin/server"
	"github.com/xxx/yyy/pkg/ssh"
	"github.com/xxx/yyy/pkg/transport"
	httppkg "github.com/xxx/yyy/pkg/util/http"
	"github.com/xxx/yyy/pkg/util/log"
	netpkg "github.com/xxx/yyy/pkg/util/net"
	"github.com/xxx/yyy/pkg/util/tcpmux"
	"github.com/xxx/yyy/pkg/util/util"
	"github.com/xxx/yyy/pkg/util/version"
	"github.com/xxx/yyy/pkg/util/vhost"
	"github.com/xxx/yyy/pkg/util/xlog"
	"github.com/xxx/yyy/server/controller"
	"github.com/xxx/yyy/server/group"
	"github.com/xxx/yyy/server/metrics"
	"github.com/xxx/yyy/server/ports"
	"github.com/xxx/yyy/server/proxy"
	"github.com/xxx/yyy/server/visitor"
)
...
func NewService(cfg *v1.ServerConfig) (*Service, error) {
	...
	if cfg.QUICBindPort > 0 {
		...
		quicTLSCfg.NextProtos = []string{"yyy"}
...
// TODO(xxx): Pass some parameters of listener/connection through context to avoid passing too many parameters.
