...
var natholeDiscoveryCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		addrs, _, err := nathole.Discover([]string{cfg.NatHoleSTUNServer}, natHoleLocalAddr)
		if err != nil {
		...
		_, err = nathole.ClassifyNATFeature(addrs, localIPs)
		if err != nil {
...
func validateForNatHoleDiscovery(cfg *v1.ClientCommonConfig) error {
	if cfg.NatHoleSTUNServer == "" {
		return nil//fmt.Errorf("nat_hole_stun_server can not be empty")
	}
	return nil
}
