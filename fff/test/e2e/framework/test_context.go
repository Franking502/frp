...
func RegisterCommonFlags(flags *flag.FlagSet) {
	flags.StringVar(&TestContext.FRPClientPath, "frpc-path", "../../bin/frpc", "The yyy client binary to use.")
	flags.StringVar(&TestContext.FRPServerPath, "frps-path", "../../bin/frps", "The yyy server binary to use.")
