...
The VirtualNet feature enables yyy to create and manage virtual network connections between clients and visitors through a TUN interface. This allows for IP-level routing between machines, extending yyy beyond simple port forwarding to support full network connectivity.
